...
<body>
    ...
    <nav class="navbar navbar-expand-lg sticky-top">
        <div class="container">
            ...
            <div>
                <a href="konsultasi.php" class="btn btn-primary rounded-pill px-4 fw-semibold">
                    Mulai Konsultasi
                </a>
            </div>
        </div>
        ...
        <div class="row justify-content-center align-items-center text-center hero-center">
            ...
            <div class="col-lg-6">
                ...
                <p class="dashboard-text mt-4">
                    Sistem pakar modern untuk membantu menentukan rekomendasi lensa terbaik berdasarkan kondisi mata, aktivitas, dan kebutuhan harian Anda.
                </p>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-4">
                <div class="feature-card h-100">
                    ...
                    <p class="text-muted mb-0">
                        Memberikan rekomendasi lensa berdasarkan aturan sistem pakar dan kebutuhan pengguna.
                    </p>
                </div>
            </div>
